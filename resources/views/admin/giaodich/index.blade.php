...
@section('container-style', 'padding: 0px;')
                ...
                <table id="myTable" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="tien">{{ number_format($giaoDich->tongtien) }} đồng</td>
                            <td>
                                @if($giaoDich->tinhtranggiaodich == 0)
                                <span class="tinhtrang-chuaduyet">Chưa duyệt</span>
                                @else
                                <span class="tinhtrang-daduyet">Đã duyệt</span>
                                @endif
                            </td>
                            <td>
